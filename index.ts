...
const quiz: {
  ...
  },
  {
    ...
    type: "list",
    message:
      chalk.green("Which operator is commonly used of string concentration in Typescript?"),
    choices: ["+", "-", "*", "/"],
  },
  {
    name: "question_4",
  ...
  },
  {
    ...
    type: "list",
    message:
      chalk.green("Which method of inquirer.js is used to start the prompt interface and recieve the input"),
